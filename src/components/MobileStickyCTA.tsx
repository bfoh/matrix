    ...
    return (
        <>
            ...
            <a
                ...
                className="fixed md:!bottom-8 left-4 md:left-5 z-40 md:z-50 w-12 h-12 md:w-14 md:h-14 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform duration-200 wa-pulse"
            >
            ...
            >
                <div className="safe-pb bg-black/95 backdrop-blur-xl border-t border-white/10 px-4 py-3 flex items-center gap-3">
                    <a
